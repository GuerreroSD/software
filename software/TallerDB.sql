...
-- 1. TABLA HISTORIAL DE ESTADOS DEL VEHÍCULO (RF-19) [cite: 31]
CREATE TABLE HISTORIAL_VEHICULOS (
    ID_HISTORIAL NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    ID_VEHICULO NUMBER NOT NULL,
    ESTADO_ANTERIOR VARCHAR2(50),
    ESTADO_NUEVO VARCHAR2(50),
    ID_USUARIO NUMBER, -- Quién hizo el cambio
    FECHA_CAMBIO DATE DEFAULT SYSDATE
);

-- 2. TABLA HISTORIAL DE REPUESTOS/INVENTARIO (RF-20) [cite: 32]
...
-- 3. ACTUALIZACIÓN TABLA REPUESTOS (Para RF-17 y RF-18)
-- Necesitamos saber cuándo se movió por última vez y su precio
